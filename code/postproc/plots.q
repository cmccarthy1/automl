...
i.gainliftplt:{
 ...
 system"mkdir",$[.z.o like "w*";" ";" -p "],folder_name:path,"/Outputs/",string[z`stdate],"/Images/Run_",string[z`sttime];
...
i.impactplot:{[r;m;z]
 ...
 system"mkdir",$[.z.o like "w*";" ";" -p "],folder_name:path,"/Outputs/",string[z`stdate],"/Run_",string[z`sttime],"/Images";
